...
namespace ScrapeEdit
{
    internal class ConsoleIDHandler
    {
        ...
        public static Dictionary<string, string[]> consoleIds_backup = new Dictionary<string, string[]>
        {
            ...
            { "gc",                  new string[] { "13",  "Nintendo Gamecube" } },
            ...
            { "megadrive32x",        new string[] { "19",  "SEGA Megadrive 32X" } },
            ...
            { "neogeopocket",        new string[] { "25",  "SNK Neo-Geo Pocket" } },
            { "atari2600",           new string[] { "26",  "Atari 2600" } },
            { "atarijaguar",         new string[] { "27",  "Atari Jaguar" } },
            { "atarilynx",           new string[] { "28",  "Atari Lynx" } },
            { "3do",                 new string[] { "29",  "Panasonic 3DO" } },
            { "ngage",               new string[] { "30",  "Nokia N-Gage" } },
            { "pce",                 new string[] { "31",  "PC Engine" } },
            ...
            { "wonderswan",          new string[] { "45",  "WonderSwan" } },
            { "wonderswancolor",     new string[] { "46",  "WonderSwan Color" } },
            ...
            { "plus4",               new string[] { "99",  "Commodore Plus/4" } },
            ...
            { "videopacg7000",       new string[] { "104", "Videopac G7000" } },
            ...
            { "msx",                 new string[] { "113", "Microsoft MSX" } },
            { "pcecd",               new string[] { "114", "PC Engine CD-Rom" } },
            ...
            { "pokemonmini",         new string[] { "211", "Nintendo Pokémon mini" } },
